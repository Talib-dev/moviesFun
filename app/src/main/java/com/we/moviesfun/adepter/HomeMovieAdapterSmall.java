...
public class HomeMovieAdapterSmall extends RecyclerView.Adapter<HomeMovieAdapterSmall.MyViewHolder> {
    private Context mContext;
    private List<Movie> movieList;



    public HomeMovieAdapterSmall(Context mContext, List<Movie> movieList) {
    ...
    @Override
    public HomeMovieAdapterSmall.MyViewHolder onCreateViewHolder
            (ViewGroup viewGroup, int i){
        View view= LayoutInflater.from(viewGroup.getContext()).
                inflate(R.layout.card_home_movie,viewGroup,false);
        return new HomeMovieAdapterSmall.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final HomeMovieAdapterSmall.MyViewHolder
                                         viewHolder,int i) {
