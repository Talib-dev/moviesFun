...
public class TopRatedTVshows extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_rated_tvshows);
        setTitle("Top Rated Shows");
        swipeContainer=(SwipeRefreshLayout)
                findViewById(R.id.top_rated_tv_shows_content);
        swipeContainer.
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent intent= new Intent(TopRatedTVshows.this,PopularTVshows.class);
                Toast.makeText
                        (TopRatedTVshows.this,
                                "Show Refreshing... ",
        ...
        recyclerView = (RecyclerView) findViewById(R.id.top_rated_tv_shows_recyclerview);
    ...
    private void loadJSON(){
        try{
            ...
            mPopularTVShowsCall = apiService.
                    getTopRatedTVShows(BuildConfig.THE_MOVIE_DB_API_TOKEN,presentPage);
...
//                        mSmoothProgressBar.progressiveStop();
                ...
                public void onFailure(Call<ShowTVResponse> call, Throwable t) {
                    ...
                    Toast.makeText(TopRatedTVshows.this, "Error ,check you internet connectivity", Toast.LENGTH_SHORT).show();
                    pd.dismiss(); }
            });
