...
public class UpcomingMovies extends AppCompatActivity {
    ...
    private Call<MovieResponse> mUpcomingMoviesCall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer=(SwipeRefreshLayout)
                findViewById(R.id.upcoming_movie_content);
        swipeContainer.
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent intent= new Intent(UpcomingMovies.this,UpcomingMovies.class);
                Toast.makeText
                        (UpcomingMovies.this,
                                "Movies Refreshed",
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (mUpcomingMoviesCall != null) mUpcomingMoviesCall.
                cancel();
    ...
    private void loadJSON(){
        try{
            ...
            mUpcomingMoviesCall = apiService.
                    getUpcomingMovies(BuildConfig.
                            THE_MOVIE_DB_API_TOKEN,presentPage);
            mUpcomingMoviesCall.enqueue(new Callback<MovieResponse>() {
                @Override
