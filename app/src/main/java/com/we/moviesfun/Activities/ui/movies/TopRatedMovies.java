...
public class TopRatedMovies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer=(SwipeRefreshLayout)
                findViewById(R.id.top_rated_movie_content);
        swipeContainer.
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent intent= new Intent(TopRatedMovies.this,TopRatedMovies.class);
                Toast.makeText
                        (TopRatedMovies.this,
                                "Movies Refreshed",
