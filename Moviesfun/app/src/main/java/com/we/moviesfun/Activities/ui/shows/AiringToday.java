...
public class AiringToday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airing_today);
        setTitle("Airing Today Shows");
        swipeContainer=(SwipeRefreshLayout)
                findViewById(R.id.airing_today_tv_shows_content);
        swipeContainer.
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent intent= new Intent(AiringToday.this,AiringToday.class);
                Toast.makeText
                        (AiringToday.this,
                                "Show Refreshing... ",
        ...
        recyclerView = (RecyclerView) findViewById(R.id.airing_today_tv_shows_recyclerview);
    ...
    private void loadJSON(){
        try{
            ...
            mPopularTVShowsCall = apiService.
                    getAiringTodayTVShows(BuildConfig.THE_MOVIE_DB_API_TOKEN,presentPage);
...
//                        mSmoothProgressBar.progressiveStop();
                ...
                public void onFailure(Call<ShowTVResponse> call, Throwable t) {
                    ...
                    Toast.makeText(AiringToday.this, "Error ,check you internet connectivity", Toast.LENGTH_SHORT).show();
                    pd.dismiss();
