...
public class PopularTVshows extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer=(SwipeRefreshLayout)
                findViewById(R.id.popular_tv_shows_content);
        swipeContainer.
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent intent= new Intent(PopularTVshows.this,PopularTVshows.class);
                Toast.makeText
                        (PopularTVshows.this,
                                "Show Refreshing... ",
        ...
        recyclerView = (RecyclerView) findViewById(R.id.popular_tv_shows_recyclerview);
    ...
    private void loadJSON(){
        try{
            ...
            mPopularTVShowsCall = apiService.
                    getPopularTVShows(BuildConfig.THE_MOVIE_DB_API_TOKEN,presentPage);
...
//                        mSmoothProgressBar.progressiveStop();
                ...
                public void onFailure(Call<ShowTVResponse> call, Throwable t) {
                    ...
                    Toast.makeText(PopularTVshows.this, "Error ,check you internet connectivity", Toast.LENGTH_SHORT).show();
                    pd.dismiss();
